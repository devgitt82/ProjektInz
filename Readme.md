...
[database-erd]: ./docs/img/database-erd-lucidchart.png
[triple-layer-arch]: ./docs/img/architektura-trojwarstwowa-klient-serwer.jpg
[sd-auth]: ./docs/img/sd-auth.png
[sd-add-asset]: ./docs/img/sd-add-asset.png
[use-cases]: ./docs/img/use-cases.png
[users-erd]: ./docs/img/users-erd.png
